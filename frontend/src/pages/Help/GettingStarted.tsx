...
const steps = [
  {
    title: '导入数据源',
    desc: '先把税务登记信息查询表导入系统，后续信息查询、管户分配、管户记录、案头分析都会自动带出企业基础信息。',
    action: '回首页导入',
    path: '/',
  ...
  {
    title: '信息查询',
    desc: '输入税号、企业名称、法定代表人或税收管理员，查看企业基础信息、案头分析、管户记录和整改进展。',
    action: '信息查询',
  ...
  {
    title: '记入管户记录并跟踪整改',
    desc: '将需要处理的疑点记入管户记录，按待核实、已排除、整改中、已整改持续记录处理过程。',
    action: '进入管户记录',
...
const workPaths = [
  { name: '单户核实', tags: ['信息查询', '看案头分析', '记管户记录', '跟踪整改'] },
  { name: '批量处理', tags: ['导入数据源', '管户分配', '批量记录风险', '导出清单'] },
