...
const faqs = [
  ...
  {
    q: '如何从一个纳税人开始处理？',
    a: '点击“信息查询”，输入税号、企业名称、法定代表人或税收管理员，查看基础信息、管户记录和分析结果。',
  },
  {
    q: '案头分析结果应该怎么看？',
  ...
  {
    q: '风险已核实不是问题怎么办？',
    a: '在管户记录或信息查询详情中记录处理情况，并将状态标记为“已排除”。',
  },
  {
    q: '权限不足怎么办？',
...
const workflow = [
  { title: '导入数据源', desc: '建立完整企业基础信息库，供信息查询、管户分配、管户记录和案头分析复用。' },
  { title: '信息查询', desc: '按税号、名称、法人或管理员查询企业。' },
  { title: '开展案头分析', desc: '上传申报、财务、发票等资料，识别风险疑点。' },
  { title: '查看疑点和证据', desc: '核对触发原因、涉及数据、计算过程、判断阈值。' },
  { title: '生成通知书和核实报告', desc: '确认文书信息后下载正式 DOCX。' },
  { title: '记入管户记录并跟踪整改', desc: '记录待核实、已排除、整改中、已整改全过程。' },
]
